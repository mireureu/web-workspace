...
- aplicationScope : Application 영역 객체에 접근
...
- JavaScript Object Notation(자바 스크립트 객체 표현법)의 약자
...
- 순수 TEXT 기반으로 TEXT 형식이 구조화 되어 잇으며 대부분의 프로그래밍 언어에서 JSON 포맷 데이터를 핸들링 할 수 있는 라이브러리를 제공해 시스템 간 객체 교환에 용이